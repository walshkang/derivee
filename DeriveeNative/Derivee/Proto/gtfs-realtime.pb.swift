...
nonisolated struct TransitRealtime_FeedMessage: SwiftProtobuf.ExtensibleMessage, Sendable {
...
nonisolated struct TransitRealtime_FeedHeader: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum Incrementality: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case fullDataset = 0
    case differential = 1
...
nonisolated struct TransitRealtime_FeedEntity: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct TransitRealtime_TripUpdate: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated struct StopTimeEvent: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct StopTimeUpdate: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    nonisolated enum ScheduleRelationship: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    nonisolated struct StopTimeProperties: SwiftProtobuf.ExtensibleMessage, Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      nonisolated enum DropOffPickupType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  /// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
  nonisolated struct TripProperties: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated struct TransitRealtime_VehiclePosition: SwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum VehicleStopStatus: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  nonisolated enum CongestionLevel: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  /// This field is still experimental, and subject to change. It may be formally adopted in the future.
  nonisolated enum OccupancyStatus: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  /// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
  nonisolated struct CarriageDetails: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated struct TransitRealtime_Alert: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum Cause: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case unknownCause = 1
  ...
  nonisolated enum Effect: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case noService = 1
  ...
  nonisolated enum SeverityLevel: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated struct TransitRealtime_TimeRange: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// A position.
nonisolated struct TransitRealtime_Position: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct TransitRealtime_TripDescriptor: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated struct ModifiedTripSelector: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated struct TransitRealtime_VehicleDescriptor: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum WheelchairAccessible: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated struct TransitRealtime_EntitySelector: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///    picked.
nonisolated struct TransitRealtime_TranslatedString: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated struct Translation: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
///    picked.
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
nonisolated struct TransitRealtime_TranslatedImage: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated struct LocalizedImage: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
/// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
nonisolated struct TransitRealtime_Shape: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
nonisolated struct TransitRealtime_Stop: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum WheelchairBoarding: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case unknown = 0
    case available = 1
    case notAvailable = 2
...
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
nonisolated struct TransitRealtime_TripModifications: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated struct Modification: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  nonisolated struct SelectedTrips: SwiftProtobuf.ExtensibleMessage, Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated struct TransitRealtime_StopSelector: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
nonisolated struct TransitRealtime_ReplacementStop: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension TransitRealtime_FeedHeader.Incrementality: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_TripUpdate.StopTimeUpdate.ScheduleRelationship: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupType: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_VehiclePosition.VehicleStopStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0INCOMING_AT\0\u{1}STOPPED_AT\0\u{1}IN_TRANSIT_TO\0")
}

nonisolated extension TransitRealtime_VehiclePosition.CongestionLevel: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_VehiclePosition.OccupancyStatus: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_Alert.Cause: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}UNKNOWN_CAUSE\0\u{1}OTHER_CAUSE\0\u{1}TECHNICAL_PROBLEM\0\u{1}STRIKE\0\u{1}DEMONSTRATION\0\u{1}ACCIDENT\0\u{1}HOLIDAY\0\u{1}WEATHER\0\u{1}MAINTENANCE\0\u{1}CONSTRUCTION\0\u{1}POLICE_ACTIVITY\0\u{1}MEDICAL_EMERGENCY\0\u{1}SPECIAL_EVENT\0")
}

nonisolated extension TransitRealtime_Alert.Effect: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_Alert.SeverityLevel: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_TripDescriptor.ScheduleRelationship: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_VehicleDescriptor.WheelchairAccessible: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension TransitRealtime_Stop.WheelchairBoarding: SwiftProtobuf._ProtoNameProviding {
