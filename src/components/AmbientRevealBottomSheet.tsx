...
interface AmbientRevealBottomSheetProps {
  poi: POI | null;
  onClose: () => void;
}

export function AmbientRevealBottomSheet({ poi, onClose }: AmbientRevealBottomSheetProps) {
        ...
        <Animated.View style={[styles.sheetContainer, sheetStyle]}>
          {BlurView ? (
            <BlurView intensity={80} tint="light" style={styles.blurContainer}>
              <SheetContent poi={poi} onClose={onClose} />
            </BlurView>
          ) : (
...
function SheetContent({ poi, onClose }: { poi: POI; onClose: () => void }) {
  return (
    <View style={styles.content}>
      ...
      <View style={styles.headerRow}>
        <View style={styles.categoryBadge}>
          <Text style={styles.categoryText}>GHOST POI REVEAL</Text>
        </View>
      ...
      {poi.reward_type && (
        <View style={styles.rewardPill}>
          ...
          <Text style={styles.rewardLabel}>{poi.reward_type}</Text>
        </View>
      )}
