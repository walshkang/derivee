...
/**
 * Wraps a Swift `(_ h3Index: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.hybridtracker.bridge.swift

  private let closure: (_ h3Index: String) -> Void

  public init(_ closure: @escaping (_ h3Index: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(h3Index: std.string) -> Void {
    self.closure(String(h3Index))
  }
